...
const ProductDetails = () => {
  ...
  // 2. سحبنا دالة الإضافة من الـ Context
    ...
    <div className="container mx-auto p-8">
      <div className="flex flex-col md:flex-row gap-8 bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="w-full md:w-2/3 flex flex-col justify-center">
          ...
          {/* 3. ربطنا الزر بالدالة */}
          <button 
            onClick={() => addToCart(product)} 
            className="bg-yellow-500 text-white font-bold py-3 px-6 rounded-lg hover:bg-yellow-600 transition w-full md:w-auto"
          >
            إضافة إلى السلة 🛒
          </button>
        </div>
